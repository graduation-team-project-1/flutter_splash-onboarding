...
import 'package:app/features/pregnant_home/view/widgets/custom_alert_dialog.dart';
import 'package:app/features/pregnant_home/view/widgets/paymants_view.dart';
import 'package:app/features/profile/models/is_notification_model.dart';
import 'package:app/features/profile/view/widgets/custom_profile_setting_item.dart';
import 'package:app/features/profile/view/widgets/custom_raing_bar.dart';
...
class _ProfileViewBodyContentState extends State<ProfileViewBodyContent> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: SizeConfig.defultSize! * 1.6),
      child: Center(
        child: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(SizeConfig.defultSize! * 1.5),
            color: ColorManager.whiteColor,
          ),
          child: Padding(
            padding: EdgeInsets.all(SizeConfig.defultSize! * .85),
  ...
  Widget buildSectionTitle(String title) {
    return Padding(
      padding: EdgeInsets.only(
        left: SizeConfig.defultSize! * 1.6,
        top: SizeConfig.defultSize! * 2.12,
      ),
      child: Text(
        title,
        style: Styles.textStyle18.copyWith(
          fontSize: SizeConfig.defultSize! * 2.12,
